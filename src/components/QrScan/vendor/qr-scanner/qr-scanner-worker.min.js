...
6,e-17,1,!0);6<b.versionNumber&&(f.setRegion(e-11,0,3,6,!0),f.setRegion(0,e-11,6,3,!0));b=f;g=[];e=h=0;f=!0;for(let k=d-1;0<k;k-=2){6===k&&k--;for(let m=0;m<d;m++){let l=f?d-1-m:m;for(let d=0;2>d;d++){let f=k-d;if(!b.get(f,l)){e++;let b=a.get(f,l);c({y:l,x:f})&&(b=!b);h=h<<1|b;8===e&&(g.push(h),h=e=0)}}}f=!f}return g}function ba(a){var b=a.height,c=Math.floor((b-17)/4);if(6>=c)return K[c-1];c=0;for(var d=5;0<=d;d--)for(var e=b-9;e>=b-11;e--)c=C(a.get(e,d),c);d=0;for(e=5;0<=e;e--)for(let c=b-9;c>=
...
function N(a,b,c,d){let e=[{x:Math.floor(a.x),y:Math.floor(a.y)}];var f=Math.abs(b.y-a.y)>Math.abs(b.x-a.x);if(f){var g=Math.floor(a.y);var h=Math.floor(a.x);a=Math.floor(b.y);b=Math.floor(b.x)}else g=Math.floor(a.x),h=Math.floor(a.y),a=Math.floor(b.x),b=Math.floor(b.y);let k=Math.abs(a-g),m=Math.abs(b-h),l=Math.floor(-k/2),p=g<a?1:-1,n=h<b?1:-1,q=!0;for(let w=g,u=h;w!==a+p;w+=p){g=f?u:w;h=f?w:u;if(c.get(g,h)!==q&&(q=!q,e.push({x:g,y:h}),e.length===d+1))break;l+=m;if(0<l){if(u===b)break;u+=n;l-=k}}c=
[];for(f=0;f<d;f++)e[f]&&e[f+1]?c.push(x(e[f],e[f+1])):c.push(0);return c}function z(a,b,c,d){let e=b.y-a.y,f=b.x-a.x;b=N(a,b,c,Math.ceil(d/2));a=N(a,{x:a.x-f,y:a.y-e},c,Math.ceil(d/2));c=b.shift()+a.shift()-1;return a.concat(c).concat(...b)}function F(a,b){let c=t(a)/t(b),d=0;b.forEach((b,f)=>{d+=Math.pow(a[f]-b*c,2)});return{averageSize:c,error:d}}function O(a,b,c){try{let d=z(a,{x:-1,y:a.y},c,b.length),e=z(a,{x:a.x,y:-1},c,b.length),f=z(a,{x:Math.max(0,a.x-a.y)-1,y:Math.max(0,a.y-a.x)-1},c,b.length),
g=z(a,{x:Math.min(c.width,a.x+a.y)+1,y:Math.min(c.height,a.y+a.x)+1},c,b.length),h=F(d,b),k=F(e,b),m=F(f,b),l=F(g,b),p=(h.averageSize+k.averageSize+m.averageSize+l.averageSize)/4;return Math.sqrt(h.error*h.error+k.error*k.error+m.error*m.error+l.error*l.error)+(Math.pow(h.averageSize-p,2)+Math.pow(k.averageSize-p,2)+Math.pow(m.averageSize-p,2)+Math.pow(l.averageSize-p,2))/p}catch(d){return Infinity}}function H(a,b){for(var c=Math.round(b.x);a.get(c,Math.round(b.y));)c--;for(var d=Math.round(b.x);a.get(d,
Math.round(b.y));)d++;c=(c+d)/2;for(d=Math.round(b.y);a.get(Math.round(c),d);)d--;for(b=Math.round(b.y);a.get(Math.round(c),b);)b++;return{x:c,y:(d+b)/2}}function ka(a){var b=[],c=[],d=[],e=[];for(let n=0;n<=a.height;n++){var f=0;let m=!1,l=[0,0,0,0,0];for(let b=-1;b<=a.width;b++){var g=a.get(b,n);if(g===m)f++;else{l=[l[1],l[2],l[3],l[4],f];f=1;m=g;var h=t(l)/7;h=Math.abs(l[0]-h)<h&&Math.abs(l[1]-h)<h&&Math.abs(l[2]-3*h)<3*h&&Math.abs(l[3]-h)<h&&Math.abs(l[4]-h)<h&&!g;var k=t(l.slice(-3))/3;g=Math.abs(l[2]-
k)<k&&Math.abs(l[3]-k)<k&&Math.abs(l[4]-k)<k&&g;if(h){let a=b-l[3]-l[4],d=a-l[2];h={startX:d,endX:a,y:n};k=c.filter(b=>d>=b.bottom.startX&&d<=b.bottom.endX||a>=b.bottom.startX&&d<=b.bottom.endX||d<=b.bottom.startX&&a>=b.bottom.endX&&1.5>l[2]/(b.bottom.endX-b.bottom.startX)&&.5<l[2]/(b.bottom.endX-b.bottom.startX));0<k.length?k[0].bottom=h:c.push({top:h,bottom:h})}if(g){let a=b-l[4],c=a-l[3];g={startX:c,y:n,endX:a};h=e.filter(b=>c>=b.bottom.startX&&c<=b.bottom.endX||a>=b.bottom.startX&&c<=b.bottom.endX||
c<=b.bottom.startX&&a>=b.bottom.endX&&1.5>l[2]/(b.bottom.endX-b.bottom.startX)&&.5<l[2]/(b.bottom.endX-b.bottom.startX));0<h.length?h[0].bottom=g:e.push({top:g,bottom:g})}}}b.push(...c.filter(a=>a.bottom.y!==n&&2<=a.bottom.y-a.top.y));c=c.filter(a=>a.bottom.y===n);d.push(...e.filter(a=>a.bottom.y!==n));e=e.filter(a=>a.bottom.y===n)}b.push(...c.filter(a=>2<=a.bottom.y-a.top.y));d.push(...e);b=b.filter(a=>2<=a.bottom.y-a.top.y).map(b=>{const c=(b.top.startX+b.top.endX+b.bottom.startX+b.bottom.endX)/
...
c[0].score+c[1].score;return{points:[a].concat(c.slice(0,2)),score:d}}).filter(a=>!!a).sort((a,b)=>a.score-b.score);if(0===b.length)return null;let {topRight:m,topLeft:l,bottomLeft:p}=ia(b[0].points[0],b[0].points[1],b[0].points[2]);c=P(a,d,m,l,p);b=[];c&&b.push({alignmentPattern:{x:c.alignmentPattern.x,y:c.alignmentPattern.y},bottomLeft:{x:p.x,y:p.y},dimension:c.dimension,topLeft:{x:l.x,y:l.y},topRight:{x:m.x,y:m.y}});c=H(a,m);e=H(a,l);f=H(a,p);(d=P(a,d,c,e,f))&&b.push({alignmentPattern:{x:d.alignmentPattern.x,
y:d.alignmentPattern.y},bottomLeft:{x:f.x,y:f.y},topLeft:{x:e.x,y:e.y},topRight:{x:c.x,y:c.y},dimension:d.dimension});return 0===b.length?null:b}function P(a,b,c,d,e){let f,g;try{({dimension:f,moduleSize:g}=ja(d,c,e,a))}catch(l){return null}var h=c.x-d.x+e.x,k=c.y-d.y+e.y;c=(x(d,e)+x(d,c))/2/g;e=1-3/c;let m={x:d.x+e*(h-d.x),y:d.y+e*(k-d.y)};b=b.map(b=>{const c=(b.top.startX+b.top.endX+b.bottom.startX+b.bottom.endX)/4,d=(b.top.y+b.bottom.y+1)/2;if(a.get(Math.floor(c),Math.floor(d)))return b=[b.top.endX-
b.top.startX,b.bottom.endX-b.bottom.startX,b.bottom.y-b.top.y+1],t(b)/b.length,b=O({x:Math.floor(c),y:Math.floor(d)},[1,1,1],a)+x({x:c,y:d},m),{x:c,y:d,score:b}}).filter(a=>!!a).sort((a,b)=>a.score-b.score);return{alignmentPattern:15<=c&&b.length?b[0]:m,dimension:f}}function Q(a){var b=ka(a);if(!b)return null;for(let e of b){b=ha(a,e);var c=b.matrix;if(null==c)c=null;else{var d=L(c);if(d)c=d;else{for(d=0;d<c.width;d++)for(let a=d+1;a<c.height;a++)c.get(d,a)!==c.get(a,d)&&(c.set(d,a,!c.get(d,a)),c.set(a,
d,!c.get(a,d)));c=L(c)}}if(c)return{binaryData:c.bytes,data:c.text,chunks:c.chunks,location:{topRightCorner:b.mappingFunction(e.dimension,0),topLeftCorner:b.mappingFunction(0,0),bottomRightCorner:b.mappingFunction(e.dimension,e.dimension),bottomLeftCorner:b.mappingFunction(0,e.dimension),topRightFinderPattern:e.topRight,topLeftFinderPattern:e.topLeft,bottomLeftFinderPattern:e.bottomLeft,bottomRightAlignmentPattern:e.alignmentPattern},matrix:b.matrix}}return null}function R(a,b){Object.keys(b).forEach(c=>
{a[c]=b[c]})}function I(a,b,c,d={}){let e=Object.create(null);R(e,la);R(e,d);d="onlyInvert"===e.inversionAttempts||"invertFirst"===e.inversionAttempts;var f="attemptBoth"===e.inversionAttempts||d;var g=e.greyScaleWeights,h=e.canOverwriteImage,k=b*c;if(a.length!==4*k)throw Error("Malformed data passed to binarizer.");var m=0;if(h){var l=new Uint8ClampedArray(a.buffer,m,k);m+=k}l=new S(b,c,l);if(g.useIntegerApproximation)for(var p=0;p<c;p++)for(var n=0;n<b;n++){var q=4*(p*b+n);l.set(n,p,g.red*a[q]+
g.green*a[q+1]+g.blue*a[q+2]+128>>8)}else for(p=0;p<c;p++)for(n=0;n<b;n++)q=4*(p*b+n),l.set(n,p,g.red*a[q]+g.green*a[q+1]+g.blue*a[q+2]);g=Math.ceil(b/8);p=Math.ceil(c/8);n=g*p;if(h){var w=new Uint8ClampedArray(a.buffer,m,n);m+=n}w=new S(g,p,w);for(n=0;n<p;n++)for(q=0;q<g;q++){var u=Infinity,r=0;for(var t=0;8>t;t++)for(let a=0;8>a;a++){let b=l.get(8*q+a,8*n+t);u=Math.min(u,b);r=Math.max(r,b)}t=(u+r)/2;t=Math.min(255,1.1*t);24>=r-u&&(t=u/2,0<n&&0<q&&(r=(w.get(q,n-1)+2*w.get(q-1,n)+w.get(q-1,n-1))/
4,u<r&&(t=r)));w.set(q,n,t)}h?(n=new Uint8ClampedArray(a.buffer,m,k),m+=k,n=new A(n,b)):n=A.createEmpty(b,c);q=null;f&&(h?(a=new Uint8ClampedArray(a.buffer,m,k),q=new A(a,b)):q=A.createEmpty(b,c));for(b=0;b<p;b++)for(a=0;a<g;a++){c=g-3;c=2>a?2:a>c?c:a;h=p-3;h=2>b?2:b>h?h:b;k=0;for(m=-2;2>=m;m++)for(u=-2;2>=u;u++)k+=w.get(c+m,h+u);c=k/25;for(h=0;8>h;h++)for(k=0;8>k;k++)m=8*a+h,u=8*b+k,r=l.get(m,u),n.set(m,u,r<=c),f&&q.set(m,u,!(r<=c))}f=f?{binarized:n,inverted:q}:{binarized:n};let {binarized:v,inverted:x}=
f;(f=Q(d?x:v))||"attemptBoth"!==e.inversionAttempts&&"invertFirst"!==e.inversionAttempts||(f=Q(d?v:x));return f}class A{constructor(a,b){this.width=b;this.height=a.length/b;this.data=a}static createEmpty(a,b){return new A(new Uint8ClampedArray(a*b),a)}get(a,b){return 0>a||a>=this.width||0>b||b>=this.height?!1:!!this.data[b*this.width+a]}set(a,b,c){this.data[b*this.width+a]=c?1:0}setRegion(a,b,c,d,e){for(let f=b;f<b+d;f++)for(let b=a;b<a+c;b++)this.set(b,f,!!e)}}class S{constructor(a,b,c){this.width=
...
0,this.byteOffset++)}if(0<a){for(;8<=a;)b=b<<8|this.bytes[this.byteOffset]&255,this.byteOffset++,a-=8;0<a&&(c=8-a,b=b<<a|(this.bytes[this.byteOffset]&255>>c<<c)>>c,this.bitOffset+=a)}return b}available(){return 8*(this.bytes.length-this.byteOffset)-this.bitOffset}}var r;(function(a){a.Numeric="numeric";a.Alphanumeric="alphanumeric";a.Byte="byte";a.Kanji="kanji";a.ECI="eci"})(r||(r={}));var y;(function(a){a[a.Terminator=0]="Terminator";a[a.Numeric=1]="Numeric";a[a.Alphanumeric=2]="Alphanumeric";a[a.Byte=
4]="Byte";a[a.Kanji=8]="Kanji";a[a.ECI=7]="ECI"})(y||(y={}));let B="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".split("");class v{constructor(a,b){if(0===b.length)throw Error("No coefficients.");this.field=a;let c=b.length;if(1<c&&0===b[0]){let d=1;for(;d<c&&0===b[d];)d++;if(d===c)this.coefficients=a.zero.coefficients;else for(this.coefficients=new Uint8ClampedArray(c-d),a=0;a<this.coefficients.length;a++)this.coefficients[a]=b[d+a]}else this.coefficients=b}degree(){return this.coefficients.length-
1}isZero(){return 0===this.coefficients[0]}getCoefficient(a){return this.coefficients[this.coefficients.length-1-a]}addOrSubtract(a){if(this.isZero())return a;if(a.isZero())return this;let b=this.coefficients;a=a.coefficients;b.length>a.length&&([b,a]=[a,b]);let c=new Uint8ClampedArray(a.length),d=a.length-b.length;for(var e=0;e<d;e++)c[e]=a[e];for(e=d;e<a.length;e++)c[e]=b[e-d]^a[e];return new v(this.field,c)}multiply(a){if(0===a)return this.field.zero;if(1===a)return this;let b=this.coefficients.length,
c=new Uint8ClampedArray(b);for(let d=0;d<b;d++)c[d]=this.field.multiply(this.coefficients[d],a);return new v(this.field,c)}multiplyPoly(a){if(this.isZero()||a.isZero())return this.field.zero;let b=this.coefficients,c=b.length;a=a.coefficients;let d=a.length,e=new Uint8ClampedArray(c+d-1);for(let h=0;h<c;h++){let c=b[h];for(let b=0;b<d;b++){var f=h+b,g=this.field.multiply(c,a[b]);e[f]=e[h+b]^g}}return new v(this.field,e)}multiplyByMonomial(a,b){if(0>a)throw Error("Invalid degree less than 0");if(0===
b)return this.field.zero;let c=this.coefficients.length;a=new Uint8ClampedArray(c+a);for(let d=0;d<c;d++)a[d]=this.field.multiply(this.coefficients[d],b);return new v(this.field,a)}evaluateAt(a){let b=0;if(0===a)return this.getCoefficient(0);let c=this.coefficients.length;if(1===a)return this.coefficients.forEach(a=>{b^=a}),b;b=this.coefficients[0];for(let d=1;d<c;d++)b=J(this.field.multiply(a,b),this.coefficients[d]);return b}}class Y{constructor(a,b,c){this.primitive=a;this.size=b;this.generatorBase=
c;this.expTable=Array(this.size);this.logTable=Array(this.size);a=1;for(b=0;b<this.size;b++)this.expTable[b]=a,a*=2,a>=this.size&&(a=(a^this.primitive)&this.size-1);for(a=0;a<this.size-1;a++)this.logTable[this.expTable[a]]=a;this.zero=new v(this,Uint8ClampedArray.from([0]));this.one=new v(this,Uint8ClampedArray.from([1]))}multiply(a,b){return 0===a||0===b?0:this.expTable[(this.logTable[a]+this.logTable[b])%(this.size-1)]}inverse(a){if(0===a)throw Error("Can't invert 0");return this.expTable[this.size-
this.logTable[a]-1]}buildMonomial(a,b){if(0>a)throw Error("Invalid monomial degree less than 0");if(0===b)return this.zero;a=new Uint8ClampedArray(a+1);a[0]=b;return new v(this,a)}log(a){if(0===a)throw Error("Can't take log(0)");return this.logTable[a]}exp(a){return this.expTable[a]}}let K=[{infoBits:null,versionNumber:1,alignmentPatternCenters:[],errorCorrectionLevels:[{ecCodewordsPerBlock:7,ecBlocks:[{numBlocks:1,dataCodewordsPerBlock:19}]},{ecCodewordsPerBlock:10,ecBlocks:[{numBlocks:1,dataCodewordsPerBlock:16}]},
